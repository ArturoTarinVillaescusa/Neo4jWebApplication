...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'ValenciaWalk.data';
    var REMOTE_PACKAGE_BASE = 'ValenciaWalk.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 6937212;
      var PACKAGE_UUID = '6aafdafa-7d92-465c-83c1-b8466812e554';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 4118921, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(4118921, 4118942, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(4118942, 5412894, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(5412894, 6909586, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(6909586, 6937212, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_ValenciaWalk.data');

    };
    Module['addRunDependency']('datafile_ValenciaWalk.data');
