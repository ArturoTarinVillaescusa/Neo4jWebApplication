...
<body>
	...
	<table style="display: visible" border=1 id="tabla">
	<%  
	...
	<script>
		...
		for (var i = 0; i < locations.length; i++) {  
			  ...
			  // If overpassed the speed limit
			  if (velocidad > 120)
				  icono = iconURLPrefix + 'red-dot.png';
			  // If technical stop
			  if (delta_t >3 && 5 > delta_t && velocidad < 10)
				  icono = 'https://maps.gstatic.com/mapfiles/ms2/micons/police.png';
			  // If technical stop
		...
		function loadNodeLocations() {
			...
			for (var i = 1; i < numRows; i++) {
				...
				locations.push(['<h4>Vehiculo: '+vehiculo+'<br/> Velocidad: '+velocidad+'<br/> Fecha: '+fecha+
				                '<br/> Latitud: '+latitud+', Longitud: '+longitud+'</h4>', latitud, longitud, velocidad, delta_t]);
			}
		}
