...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'ManchesterWalk.data';
    var REMOTE_PACKAGE_BASE = 'ManchesterWalk.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 6937010;
      var PACKAGE_UUID = '1f08184f-ab7d-41f6-8577-a5caadb4cae9';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 4118719, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(4118719, 4118740, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(4118740, 5412692, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(5412692, 6909384, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(6909384, 6937010, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_ManchesterWalk.data');

    };
    Module['addRunDependency']('datafile_ManchesterWalk.data');
